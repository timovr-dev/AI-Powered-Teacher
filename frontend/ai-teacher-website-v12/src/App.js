...
import QuizPage from './components/QuizPage'; // Import
// Import the FreeTextQuizPage at the top of App.js
import FreeTextQuizPage from './components/FreeTextQuizPage';
      ...
      >
        ...
        <main className="flex-grow p-6 overflow-hidden">
          <Switch>
           ...
           <Route path="/free-text-quiz">
              <FreeTextQuizPage theme={theme} />
           </Route>
          </Switch>
        </main>
